...
@section('content')
    <el-row class="pb-2">
        <el-col :md="24">
            <el-card>
                <div slot="header"><i class="el-icon-edit text-primary"></i> Edit ResourceGroup</div>
                <div>
                    <el-form :model="form" :rules="rules" ref="editForm" @submit.native.prevent="submitForm('editForm')">
                        ...
                        <el-form-item class="text-right">
                            <el-button native-type="submit" type="primary" icon="el-icon-check"> Save
                            </el-button>
    ...
    <script>
        new Vue({
            ...
            mounted() {
                ...
                axios.get('/api/resourcegroup/{{$id}}')
            ...
            methods: {
                submitForm(formRefs) {
                    this.$refs[formRefs].validate((valid) => {
                        if (valid) {
                            axios.put('{{route('api.resourcegroup.update', $id)}}', this.form)
                                .then(res => {
