(function ($, DataTable) {
    ...
    DataTable.ext.buttons.postExcel = {
        ...
        text: function (dt) {
            return '<i class="fa fa-file-excel text-success"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="fa fa-undo text-warning"></i> ' + dt.i18n('buttons.reset', 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function (dt) {
            return '<i class="fa fa-sync text-info"></i> ' + dt.i18n('buttons.reload', 'Reload');
        },
    ...
    DataTable.ext.buttons.create = {
        ...
        text: function (dt) {
            return '<i class="el-icon-plus text-primary"></i> ' + dt.i18n('buttons.create', 'Create');
        },
